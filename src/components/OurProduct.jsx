...
const OurProduct = () => {
    ...
    return (
        <section className="w-full min-h-screen bg-[rgba(0,173,40,0.1)] flex flex-col relative px-4 sm:px-6 lg:px-8 py-6">
            <div className="absolute inset-0 -z-10 overflow-hidden">
                <svg
                    viewBox="0 0 1440 200"
                    className="w-full h-[200px] absolute left-1/2 -translate-x-1/2 top-3/5 -translate-y-1/2"
                    fill="none"
                >
                    <path
                        d="M0,50 
            ...
            <div className="w-full flex items-center justify-center relative mt-12">
                <button
                    onClick={prev}
                    className="absolute left-2 sm:left-30 z-10 bg-white p-2 rounded-full shadow hover:scale-105 transition"
                >
                    <ChevronLeft size={28} />
                </button>
                <div className="w-full max-w-[1200px] overflow-hidden">
                    ...
                    >
                        {products.map((item) => (
                            <div
                                key={item.id}
                                className="min-w-full md:min-w-[50%] flex justify-center px-3"
                            >
                                <div className="
                                    w-full
                                    max-w-[520px]
                                ...
                                ">
                                    ...
                                    <button className="mb-6 mt-4">
                                        <div className="bg-[#EB3223] text-white text-sm sm:text-base px-8 py-2 
                ...
                <button
                    onClick={next}
                    className="absolute right-2 sm:right-30 z-10 bg-white p-2 rounded-full shadow hover:scale-105 transition"
                >
